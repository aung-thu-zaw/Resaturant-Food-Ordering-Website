...
const handleRemoveRating = () => router.push({ query: { ...route.query, rating: undefined } })
</script>

<template>
  <div class="px-2 flex items-center">
    <div v-show="route.query?.rating || route.query?.category" class="flex items-center">
      ...
      <div class="flex items-center space-x-3">
        ...
        >
          <div class="whitespace-nowrap text-xs font-bold text-gray-700 capitalize">
            Rating : {{ route.query?.rating }} stars
          </div>
          <button
