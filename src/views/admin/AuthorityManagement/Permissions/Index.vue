...
import { usePermissionStore } from '@/stores/dashboard/permission'
import { storeToRefs } from 'pinia'
import { onMounted, watch } from 'vue'
import { useRoute } from 'vue-router'
import { useQueryStringParams } from '@/composables/useQueryStringParams'

useTitle('Permissions - Restaurant Food Ordering')
...
onMounted(async () => await store.getAllPermissions(dashboardParams.value))

watch(
  () => route.query,
  async () => await store.getAllPermissions(dashboardParams.value)
)
</script>
  ...
  <DashboardLayout>
    ...
    <div class="min-h-screen py-10">
      ...
      <div class="border border-gray-300 bg-white rounded-md shadow-sm shadow-gray-200 px-5 py-3">
        ...
        >
          <DashboardTableDataSearchBox placeholder="Search by name or group" />
        ...
        <TableContainer>
          <Table :items="permissions.data ?? []">
            ...
            <template #table-header>
              ...
              <SortableTableHeaderCell label="Permission Name" sort="name" />
            </template>
