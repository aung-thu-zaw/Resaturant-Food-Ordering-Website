...
useTitle('Create Employee Position - Restaurant Food Ordering')
...
const handleCreateEmployeePosition = async () => {
  await store.createEmployeePosition({ ...form }, isCreateAnother.value)
  ...
  <DashboardLayout>
    <div class="min-h-screen py-10">
      ...
      <div class="border p-10 bg-white rounded-md">
        <form @submit.prevent="handleCreateEmployeePosition" class="space-y-4 md:space-y-6">
          <div>
